...
model = SentenceTransformer("atasoglu/1mb-turkish-embeddings")
print("Embedding...")
...
faiss.write_index(index, "data/atasoglu.index")
with open("data/atasoglu_metadata.json", "w", encoding="utf-8") as f:
